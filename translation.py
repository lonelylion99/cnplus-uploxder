...
This is a Telegram URL Uploader Bot! by
@thesatyam 😇
...
If it has some bugs or problem ,
Contact Devloper : @thesatyamxyz
"""
...
Support Developer : @thesatyamxyz
"""
...
URL | newfilename | username | password"""
    ...
    UPGRADE_TEXT = "<b> Create own Clone Bot.. 🤖 </b>  \n\n<a href='https://github.com/satyamverma43/URL-Uploader'>Click here, Fork and deploy!!</a>"
    
    DOWNLOAD_START = "Downloading the content to my server 😋"
    
    UPLOAD_START = "Yeah Boy Uploading It 🤒"
